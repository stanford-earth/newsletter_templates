...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 640px){
            ...
            /*------ top header ------ */
            .header-bg{width: 640px !important; height: 10px !important;}
            .main-header{line-height: 28px !important;}
            .main-subheader{line-height: 28px !important;}

            /*----- --features ---------*/
            .feature{width: 620px !important;}
            .feature-middle{width: 600px !important; text-align: center !important;}
            .feature-img{width: 600px !important; height: auto !important;}

            .container{width: 640px !important;}
            .container-middle{width: 620px !important;}
            ...
            .banner{width: 617px !important; height: auto !important;}
            .banner td {padding: 3px 5px;}
            /*------ sections ---------*/
            .section-item{width: 600px !important;}
            .section-img{width: 600px !important; height: auto !important;}
            /*------- prefooter ------*/
            ...
            /*------- footer ------*/
            .top-bottom-bg{width: 620px !important; height: auto !important;}
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="container" bgcolor="FFFFFF">
        ...
        <tr>
            <td>
                <table width="735" border="1" bordercolor="#CCCCCC" align="center" cellpadding="0" cellspacing="0" class="container-middle section">
                    <tr>
                        <td height="27" bgcolor="<?= $section['bgcolor'] ?>" class="head">
                            <?= $section['title'] ?>
                        </td>
                    </tr>
                    <tr mc:repeatable mc:hideable>
                        <td valign="top" class="feature" mc:edit="<?= $section['id'] ?>-article">
                            <img border="0" align="left" class="main-image" src="https://stanford.box.com/shared/static/mpvufg2q88rppairlub6.png">
                            <div class="subhead"><a href="">header</a></div>
                            Copy
                        </td>
                    </tr>
                    <tr mc:hideable>
                        <td class="links">
                            <span class="title" mc:edit="$section['id'] ?-listtitle">List Title</span>
                            <ul>
