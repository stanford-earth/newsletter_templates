	    ...
	    <! -- begin section -->
			...
			<? if($section['features']) { ?>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="" valign="top" class="first"><a href="" style="color: #cc0000 !important;"><img width="200" height="126" mc:edit="<?= $section['id'] ?>-image" class="main-image" border="0" src="https://stanford.box.com/shared/static/ut0loizerxvgef3ht72i.png"></a></td>
						<td width="10">&nbsp;</td>
						<td valign="top">
